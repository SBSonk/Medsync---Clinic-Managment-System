...
const Dashboard = () => {
    ...
    const recentAppointmentsTable = [
        ...
        {name: "Patient ID", selector: (row) => row.patient_id, width: "15%", center: true},
        {name: "Doctor ID", selector: (row) => row.doctor_id, width: "15%", center: true},
        {name: "Date/Time", selector: (row) => row.date_time, width: "15%", center: true},
    ...
    const availableEmployeesTable = [
        {name: "ID", selector: (row) => row.id, width: "10%", center: true},
        {name: "Person ID", selector: (row) => row.person-id, width: "15%", center: true},
        {name: "Occupation", selector: (row) => row.occupation, width: "15%", center: true},
        {name: "Department", selector: (row) => row.department, width: "15%", center: true},
        {name: "Schedule", selector: (row) => row.schedule, width: "15%", center: true}
    ]
            ...
            <div className="mainContent">
                ...
                <div className="bottomRow">
                    <div className="availableEmployees">
                        <DataTable
                            columns={availableEmployeesTable}
                            data={employees}
                        />
                    </div>
                    <div className="todaysAppointments">
                        <DataTable
                            columns={todaysAppointmentsTable}
                            data={appointments}
                        />
                    </div>
                </div>
